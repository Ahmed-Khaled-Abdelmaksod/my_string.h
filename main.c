...
int main () {
   ...
   */
   ...
   //_______________________________ start of testing my_strstr _______________________________
   ...
   //_______________________________ END of testing my_strstr _______________________________
