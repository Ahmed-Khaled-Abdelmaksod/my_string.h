...
/*_______________________________ End of my_strstr _______________________________*/

char *my_strstr(const char *haystack, const char *needle) // fix
{
    int inner_counter = 0;
    int outer_counter = 0;
    int inner_2_counter =0;
    int flag =1;
    const char* ptr_haystack = haystack;
    const char* ptr_needle = needle;
    const char* ptr_haystack_2 = NULL;
    const char* ptr_needle_2 = NULL;
    const char* ptr_returned = NULL;
    short flag_2 =0;
    ...
    {
        for(outer_counter=0;outer_counter<my_strlen(haystack);outer_counter++)
        {
            if((*ptr_haystack) == (*ptr_needle))
            {
                ptr_haystack_2 = ptr_haystack;
                ptr_needle_2 = ptr_needle;
                for(inner_counter=1;inner_counter<my_strlen(haystack);inner_counter++)
                {
                    if((*ptr_haystack_2) == (*ptr_needle_2))
                    {
                        ptr_haystack_2++;
                        ptr_needle_2++;
